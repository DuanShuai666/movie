  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="头像相对路径" prop="profilePath">
        <el-input
          v-model="queryParams.profilePath"
          placeholder="请输入头像相对路径"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="personList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="性别：0未设置，1女，2男" align="center" prop="gender" />
      <el-table-column label="头像相对路径" align="center" prop="profilePath" />
