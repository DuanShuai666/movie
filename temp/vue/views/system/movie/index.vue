  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="评分" prop="voteAverage">
        <el-input
          v-model="queryParams.voteAverage"
          placeholder="请输入评分"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="海报相对路径" prop="posterPath">
        <el-input
          v-model="queryParams.posterPath"
          placeholder="请输入海报相对路径"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="背景图相对路径" prop="backdropPath">
        <el-input
          v-model="queryParams.backdropPath"
          placeholder="请输入背景图相对路径"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="movieList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="简介" align="center" prop="overview" />
      ...
      <el-table-column label="海报相对路径" align="center" prop="posterPath" />
      <el-table-column label="背景图相对路径" align="center" prop="backdropPath" />
